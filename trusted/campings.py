...
print("\n=== Province Data Quality Report (campings_ocupacion) ===")
...
for prov in provinces:
    ...
    if count_clean > 0:
        ...
        print(f"   - Rows dropped (VIAJEROS=0): {count_dropped}")
...
tgt_db, tgt_tbl = "trusted", "campings_ocupacion_selected"
