...
def process_trafico_semana_selected():
    """
    ETL job to clean and filter weekly traffic data (trafico_semana),
    performing data quality checks and loading the trusted Iceberg table.
    """
    ...
    # 4️⃣ Provinces of interest
    provinces = ["Madrid", "Barcelona", "Sevilla", "Illes Balears", "Valencia"]

    # Province summary
    print("\n=== Province Data Quality Report (after cleaning) ===")
    for prov in provinces:
        ...
        if count_clean > 0:
            ...
            print(f"   - Rows dropped (IMD_VEHICULO_TOTAL=0): {count_total - count_clean}")
    ...
    print("✅ Trusted load complete for 'trafico_semana_selected'.")

    spark.stop()


if __name__ == "__main__":
    process_trafico_semana_selected()
